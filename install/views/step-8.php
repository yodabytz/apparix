<div class="card">
    ...
    <div style="background: #f9fafb; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
        ...
        <div style="display: grid; gap: 12px;">
            <div>
                ...
                <?php echo htmlspecialchars($_SESSION['install']['license_key'] ?? ''); ?>
                <span style="color: #10b981; font-size: 0.85rem;">(<?php echo ucfirst(htmlspecialchars($_SESSION['install']['license_edition'] ?? '')); ?>)</span>
            </div>
            <div>
            ...
            <div>
                <strong>Theme:</strong>
                <?php echo ucfirst(htmlspecialchars($_SESSION['install']['theme'] ?? 'apparix')); ?>
            </div>
        </div>
    </div>
    ...
    <form method="POST" action="/install?step=8" id="install-form">
        <div class="form-actions">
            <a href="/install?step=7" class="btn btn-secondary">Back</a>
